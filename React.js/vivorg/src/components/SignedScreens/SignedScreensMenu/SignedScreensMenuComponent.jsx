...
export default function SignedScreensMenuComponent({ ...props }) {
    ...
    return (
        <>
            <Button className='SignedScreensNavbtn' variant="primary" onClick={handleShow} >
            ...
            <Offcanvas show={show} onHide={handleClose} {...props}>
                ...
                <Offcanvas.Body>
                    <Col>
                        <Row>
                            <Button className='offSignedScreensNavbtn' onClick={() => navigate('/services')}>Services Provided</Button>
                        </Row>
                        <Row>
                            <Button className='offSignedScreensNavbtn' onClick={() => navigate('/team')}>Our Team</Button>
                        </Row>
                        <Row>
                            <Button className='offSignedScreensNavbtn' onClick={onLogout}>Logout</Button>
                        </Row>
                    </Col>
                </Offcanvas.Body>
