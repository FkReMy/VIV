...
export default function HomeMenuComponent({ ...props }) {
  ...
  return (
    <>
      <Button className='homeNavbtn' variant="primary" onClick={handleShow} >
      ...
      <Offcanvas show={show} onHide={handleClose} {...props}>
        ...
        <Offcanvas.Body>
          <Col>
            <Row>
            <Button className='homeNavbtn' onClick={() => navigate('/services')}>Services Provided</Button>
            </Row>
            <Row>
              <Button className='homeNavbtn' onClick={() => navigate('/team')}>Our Team</Button>
            </Row>
          </Col>
